...
// Lazy load heavy ShaderGradient components
...
const Home = () => {
  ...
  return (
    <section className={styles?.pageContainerHome}>
      ...
      />
      <Suspense fallback={<div style={{ position: 'absolute', height: '100%', width: '100%', backgroundColor: '#000' }}></div>}>
        <ShaderGradientCanvas
        style={{
          position: 'absolute',
          height: '100%',
